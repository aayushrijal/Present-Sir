...
if(localStorage["data"]!=undefined){
		localData=localStorage["data"].split(",");
	}
for(i in localData){
	$("#addGroup").prepend($(document.createElement("div")).html(localData[i]).addClass("addGroup"));
}
*/
...
db.transaction(function(transaction){
		transaction.executeSql('INSERT INTO classIndex(id,nameOfClass) VALUES(?)',[temp]);
});
